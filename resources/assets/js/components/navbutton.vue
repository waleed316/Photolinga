    ...
    <div>
        ...
        <li class="nav-item dropdown">
            ...
            <div
                ...
                <h5 class="dropdown-heading text-center">Messages</h5>
                        ...
                        <ul class="message-list">
                            <li v-for="list in navList">
                                <tr>
                                    <td class="img-top-padding pb-0">
                                        <a href="#" class="message-anchor">
                                            ...
                                            <img
                                                ...
                                                <img src="/images/person-2.jpg" alt="" class="message-profile" v-else="v-else"></a>
                                            </td>
                                            <td class="pb-0">
                                                <a
                                                    href="#"
                                    ...
                                    <li v-if="navList.length == 0" class="no-message">
                                        <a href="#" class="message-anchor">
                                            No new message
                                        </a>
                                    </li>
