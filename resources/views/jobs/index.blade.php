			...
			<div class="col-xl-8 col-lg-6 col-md-6 col-sm-6">
				<form class="form" method="GET" action="{{ route('jobs') }}">
					<div class="input-group form-search">
						<input type="text" name="location" class="form-control navbar-search" placeholder="Search by Location">
		...
		<div class="row jobs-top-margin">
			...
			<div class="col-xl-2 col-lg-3 col-md-3 col-sm-12">
				...
				<ul class="recent-search-list">
					...
					<li>
						<a class="recent-search" href="/jobs/browse/{{ $category->slug }}">{{ $category->name }}</a>
					</li>
					@endforeach
				</ul>
			</div>
				...
				<ul class="profile-list">
					<li>
						<a href="{{ route('profile',Auth::user()) }}">
							<img src="{{ asset(auth()->user()->avatar()) }}" alt="" class="img-fluid profile-img">
