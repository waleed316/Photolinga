...
<html lang="en">
    <head>
        ...
        <script
            async="async"
            src="https://www.googletagmanager.com/gtag/js?id=UA-71603745-3"></script>
        <script>
        ...
        <link
            ...
            crossorigin="anonymous">
        <link
            href="https://fonts.googleapis.com/css?family=Raleway:500,600,300,700"
            rel="stylesheet">
        <link
        ...
        asset('vue2-autocomplete-js/dist/style/vue2-autocomplete.css')}}"> -->
        <!-- <link rel="stylesheet"
    ...
    <body style="padding:0!important">
        ...
        <script
            ...
            src="https://cdnjs.cloudflare.com/ajax/libs/axios/0.17.1/axios.js"></script>
        <div id="fb-root"></div>
            ...
            function readURL(input) {
                if (input.files && input.files[0]) {
                    ...
                    reader.onload = function (e) {
                        $('#display_thumbnail').attr('src', e.target.result);
                    };
