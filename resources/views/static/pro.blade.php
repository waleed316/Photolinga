                ...
                <div class="container search-bar">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 text-center">
                            ...
                            <h5 class="text-center do-heading2 pro-heading1">Freelance service for the lean
                                Enterpreneur</h5>
                            <button class="btn let-talk-btn" data-toggle="modal" data-target="#myModal"
                                    style="margin-top:0!important">Let's Talk
                            </button>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-10 col-lg-10 col-md-10 col-sm-12 text-center">
                    ...
                    <p class="lead why-para">With Photolinga Pro we personally sort through Photolinga’s talent
                        marketplace to pinpoint and pre-vet the best professionals for your specific needs. Savvy teams
                        use Photolinga Pro to focus on getting more done, sooner.</p>
                </div>
                <div class="col-xl-1 col-lg-1 col-md-1 col-sm-12"></div>
            </div>
                    ...
                    <div class="container profile-name1">
                        <div class="row">
                            <div class="col-xl-12 text-center">
                                <h4 class="text-center do-heading1 pro-heading2">Pro talent: Work with a perfect
                                    fit</h4>
                                <h5 class="text-center do-heading2 pro-heading1">We use our data science expertise
                                    combined with experienced talent specialists to tailor the search to your needs.
                                    Explore Pros in our most popular categories:</h5>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row double-margin">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    ...
                    <p class="pro-service-desc">Your talent specialist focuses on finding freelancers with the expertise
                        you need. You also get priority support to help you streamline collaboration and paying on
                        Upwork. See how we handpick your Pro through this meticulous 5-step process.</p>
                </div>
                ...
                <div class="row text-center jobs-top-margin">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                 ...
                                 style="enable-background:new 0 0 384 384;" xml:space="preserve"><g>
                                    <g>
                                        ...
                                        <p>Sign up for Upwork Pro, then review and get help crafting your project
                                            requirements with your talent specialist.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 text-center">
                        <div class="pro-icon-padding">
                            ...
                            <p>We’ll post your job, then screen all interested applicants. You get a shortlist of
                                freelancers with required skills, experience and fit.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 text-center">
                        <div class="pro-icon-padding">
                            ...
                            <p>Interview favorites, then hire, track work and pay through our platform. Your Upwork
                                support team is available to help you maximize your productivity and budget.</p>
                        </div>
                    </div>
                </div>
            </div>
